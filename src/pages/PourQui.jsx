...
const segments = [
  { n: 'ONG & Associations', img: 'p_seg_ong.jpg', color: '#0E47AB', ex: 'Children of Africa, Hope Life CI, GirlUp CI', pb: 'Coordination artisanale, invisibilité des actions, manque de traçabilité financière.', sol: ['Gestion centralisée', "Page d'impact publique", 'Reporting bailleurs automatisé', 'Connexion RSE'] },
  { n: 'Mutuelles & Tontines', img: 'p_seg_mut.jpg', color: '#D4A75B', ex: 'MUGEF-CI, MUGASCI, MUSCOP-CI', pb: 'Suivi manuel des cotisations, conflits sur les montants, perte de données.', sol: ['Cotisations automatisées', 'Historique sécurisé', 'Alertes & relances', 'Mobile Money'] },
  { n: 'Alumni & Jeunesse', img: 'p_seg_alum.jpg', color: '#0a0a0a', ex: 'INPHB Alumni, BDE, JCI', pb: 'Diaspora déconnectée, événements non coordonnés, absence d\'annuaire.', sol: ['Annuaire alumni', 'Programme mentorat', 'Événements + billetterie', 'Réseau global'] },
  { n: 'Réseaux Professionnels', img: 'p_seg_pro.jpg', color: '#0E47AB', ex: 'Jacobleu, SangCoolheur', pb: 'Engagement dispersé, monétisation inexistante, valeur diluée.', sol: ['Espaces collaboratifs', 'Contenus premium', 'Matching expertise', 'Analytics'] },
  { n: 'Groupes Religieux', img: 'p_seg_rel.jpg', color: '#D4A75B', ex: "Vases d'Honneur, AEBECI, Diocèse", pb: 'Coordination multi-paroisses, collectes informelles, fidèles éparpillés.', sol: ['Communication ciblée', 'Cagnottes traçables', 'Gestion des fidèles', 'Événements lives'] },
  { n: 'Leaders & Influenceurs', img: 'p_seg_lead.jpg', color: '#0a0a0a', ex: 'Artistes, personnalités, pasteurs', pb: 'Audience volatile, dépendance aux algorithmes, pas de revenus directs.', sol: ['Communauté propriétaire', 'Monétisation directe', 'Indépendance algo', 'Q&A + lives privés'] },
]
    ...
    <div className="page">
            ...
            <div className="container">
              <div className="two-col-grid">
                <div style={{ order: reverse ? 2 : 1, borderRadius: 32, overflow: 'hidden', aspectRatio: '4/5', position: 'relative' }}>
                  <img src={`/assets/${s.img}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} alt={s.n} />
                ...
                <div style={{ order: reverse ? 1 : 2 }}>
                  ...
                  <NavLink to="/inscription" className="btn btn-dark" style={{ marginTop: 28, display: 'inline-flex' }}>
      ...
      <section style={{ padding: '120px 64px', background: '#0E47AB', color: 'white' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <h2 style={{ fontSize: 72, color: 'white' }}>Vous ne vous reconnaissez<br />dans aucun segment ?</h2>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', marginTop: 40, flexWrap: 'wrap' }}>
            ...
            <button className="btn btn-outline-white btn-xl">Prendre un appel découverte</button>
          </div>
        </div>
      </section>
