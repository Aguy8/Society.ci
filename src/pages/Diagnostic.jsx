  ...
  return (
    <div style={{ marginBottom: 44 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
        <div style={{ width: 26, height: 26, background: color || '#0E47AB', borderRadius: 7, display: 'grid', placeItems: 'center', flexShrink: 0 }}>
          <span style={{ color: color === '#D4A75B' ? '#0a0a0a' : 'white', fontWeight: 800, fontSize: 12 }}>{num}</span>
        </div>
...
export default function Diagnostic() {
  ...
  const accentColor = s?.color || '#0E47AB'

  const challenges = s ? s.pbDetail : [
    'Suivi manuel des membres et cotisations',
    'Communications éparpillées sur plusieurs canaux',
    'Aucun rapport d\'impact structuré pour les partenaires',
    'Coordination difficile des événements et activités',
  ]

  return (
    <>
      {/* Barre d'action — masquée à l'impression */}
      <div className="no-print" style={{ background: '#0a0a0a', padding: '16px 40px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'sticky', top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <button
            ...
            style={{ padding: '10px 22px', background: '#D4A75B', color: '#0a0a0a', border: 'none', borderRadius: 999, fontWeight: 700, fontSize: 14, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <div style={{ maxWidth: 800, margin: '40px auto 80px', padding: '0 32px', fontFamily: 'Inter, system-ui, sans-serif', color: '#0a0a0a', fontSize: 14 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 40, paddingBottom: 28, borderBottom: `2.5px solid ${accentColor}` }}>
          <div>
            <div style={{ fontSize: 26, fontWeight: 800, letterSpacing: '-0.04em', color: '#0E47AB' }}>
              Society<span style={{ color: '#D4A75B' }}>.</span>
            </div>
          ...
          <div style={{ textAlign: 'right' }}>
            ...
            {s && (
              <div style={{ marginTop: 8, padding: '3px 12px', background: accentColor, color: accentColor === '#D4A75B' ? '#0a0a0a' : 'white', borderRadius: 999, fontSize: 11, fontWeight: 700, display: 'inline-block' }}>
                {s.nom}
              </div>
            )}
          </div>
        ...
        <p style={{ color: '#6B6B6B', fontSize: 14, marginBottom: 44, lineHeight: 1.65, maxWidth: 560 }}>
          Ce formulaire nous aide à comprendre vos besoins réels, vos contraintes actuelles et vos ambitions. Remplissez-le à votre rythme — 15 minutes suffisent. Retournez-le par email ou remettez-le lors de votre démo.
        </p>
        ...
        {/* PARTIE 3 */}
        <Section num="3" color="#D4A75B" label="Outils utilisés actuellement">
        ...
        <Section num="4" color="#5C2E91" label="Vos priorités">
          ...
          <div style={{ display: 'grid', gap: 8 }}>
            {[
              ...
              'Produire des rapports d\'impact pour les bailleurs / partenaires',
        ...
        {/* PARTIE 5 — NPS */}
        <Section num="5" color="#166534" label="Évaluation & intérêt pour Society">
          ...
          <div style={{ padding: 24, background: '#F0F4FF', borderRadius: 16, border: '1.5px solid rgba(14,71,171,0.15)' }}>
            <p style={{ fontSize: 14, fontWeight: 700, color: '#0E47AB', marginBottom: 4 }}>
              Score NPS — Si Society répondait pleinement à vos attentes…
            </p>
            <p style={{ fontSize: 13, color: '#3A3A3A', marginBottom: 0 }}>
        ...
        {/* PARTIE 6 */}
        <Section num="6" color="#0a0a0a" label="Prochaines étapes">
          <div style={{ display: 'grid', gap: 12, marginBottom: 24 }}>
            {[
              'Je suis intéressé(e) par une démonstration Society (30 min, gratuite)',
              'Je préfère d\'abord tester en autonomie (plan gratuit — inscription sur society.ci)',
          ...
          <Field label="Créneau préféré pour la démo" wide />
          ...
          <div style={{ marginTop: 40, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48 }}>
            <div>
              <div style={{ height: 1, background: '#0a0a0a', marginBottom: 8 }} />
        ...
        <div style={{ borderTop: '1.5px solid #E5E5E5', paddingTop: 24, marginTop: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
          <div>
            <div style={{ fontSize: 18, fontWeight: 800, letterSpacing: '-0.03em', color: '#0E47AB' }}>Society<span style={{ color: '#D4A75B' }}>.</span></div>
          ...
          <div style={{ fontSize: 12, color: '#6B6B6B', textAlign: 'right', lineHeight: 1.7 }}>
            <div>Retournez ce formulaire à : <strong>contact@difero.ci</strong></div>
            <div>Ou inscrivez-vous directement sur <strong>society.ci</strong></div>
          </div>
        </div>
      </div>
    </>
