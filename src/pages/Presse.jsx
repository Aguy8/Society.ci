...
const communiques = [
  {
    ...
    excerpt: 'Le financement sera utilisé pour compléter l\'équipe produit, lancer la version bêta et établir des partenariats stratégiques avec des institutions ivoiriennes.',
  },
  {
    date: '3 mars 2026',
    tag: 'Lancement',
    title: 'Lancement de la liste d\'attente bêta : 1 200 communautés s\'inscrivent en moins de 30 jours',
    excerpt: 'La réponse du marché confirme l\'appétit des leaders africains pour une plateforme de gestion communautaire pensée pour leurs réalités.',
  },
  {
...
const stats = [
  { value: '1 200+', label: 'Communautés en liste d\'attente' },
  { value: '14', label: 'Pays représentés en Afrique' },
  { value: '8', label: 'Membres dans l\'équipe fondatrice' },
  { value: '4,9/5', label: 'Score pilotes utilisateurs' },
]
...
export default function Presse() {
  return (
    <div className="page">
      ...
      <section style={{ padding: '120px 64px 80px', background: '#0a0a0a', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <h1 style={{ fontSize: 90, marginTop: 24, lineHeight: 0.9, color: 'white', maxWidth: 900 }}>
            Society dans<br />
            <span style={{ color: '#D4A75B' }}>les médias.</span>
          </h1>
          ...
          <div style={{ display: 'flex', gap: 16, marginTop: 48, flexWrap: 'wrap' }}>
            <button className="btn btn-gold" style={{ fontSize: 16 }}>
      ...
      <section style={{ padding: '80px 64px', background: '#0E47AB' }}>
            ...
            {communiques.map((c, i) => (
              <div key={i} style={{ padding: '36px 40px', border: '1px solid #EBEBEB', borderRadius: 20, display: 'grid', gridTemplateColumns: '200px 1fr auto', gap: 32, alignItems: 'center', background: 'white' }}>
                <div>
                  ...
                  <span style={{ display: 'inline-block', padding: '5px 12px', background: '#E8F0FD', color: '#0E47AB', borderRadius: 999, fontSize: 11, fontWeight: 700, letterSpacing: '0.04em' }}>
                    {c.tag}
                  </span>
                </div>
                <div>
                ...
                <button style={{ whiteSpace: 'nowrap', padding: '12px 24px', background: '#F2F2F2', border: 'none', borderRadius: 10, fontSize: 13, fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}>
                  Lire <Icon name="arrow" size={13} color="#0a0a0a" />
                </button>
              </div>
            ))}
          </div>
        ...
        <div className="container">
          <div className="two-col-grid">
            <div>
              ...
              <p style={{ fontSize: 16, color: '#3A3A3A', marginTop: 16, lineHeight: 1.6 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <div style={{ background: '#0E47AB', borderRadius: 20, padding: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 100, gridColumn: '1 / -1' }}>
                ...
                <div style={{ width: 8, height: 8, borderRadius: 999, background: '#D4A75B', marginLeft: 6, marginBottom: 18 }} />
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: '80px 64px 120px' }}>
        <div className="container">
          <div style={{ background: '#0a0a0a', borderRadius: 32, padding: '64px 80px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
            <div>
              <span style={{ fontSize: 13, fontWeight: 700, letterSpacing: '0.06em', color: '#D4A75B' }}>● CONTACT PRESSE</span>
            ...
            <div style={{ display: 'grid', gap: 20 }}>
              <div style={{ padding: '24px 28px', background: 'rgba(255,255,255,0.07)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.1)' }}>
                ...
                <div style={{ fontSize: 14, color: '#D4A75B', marginTop: 4 }}>presse@society.ci</div>
              </div>
              <div style={{ padding: '24px 28px', background: 'rgba(255,255,255,0.07)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              <button className="btn btn-gold" style={{ fontSize: 15 }}>
